...
public class MembershipController {
	...
	public CustomApiResponse<MembershipStatusResponseDto> enrollMembership(
		@AuthenticationPrincipal CustomUserDetails customUserDetails,
		@Valid @RequestBody EnrollMembershipRequestDto requestDto) {
		MembershipStatusResponseDto responseDto = membershipService.enrollMembership(
			customUserDetails.getUser().getId(), requestDto);
