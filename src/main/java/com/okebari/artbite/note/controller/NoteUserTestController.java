			    ...
			    <div class="page-container">
			        ...
			        <div class="grid-container">
			            ...
			            <div class="container">
			                <h2>북마크 (Bookmark)</h2>
			                <div class="form-group">
			                    <label for="bookmark-note-id">북마크할 Note ID</label>
			            ...
			            <div class="container">
			                <h2>질문 답변 (Answer)</h2>
			                <div class="form-group">
			                    <label for="question-id">답변할 Question ID</label>
